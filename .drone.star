def main(ctx):
    ...
    all_image_tags_arches = [{'tags': ['14.04', 'trusty'], 'arches': ['arm64v8', 'arm32v7', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['16.04', 'xenial'], 'arches': ['arm64v8', 'arm32v7', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['18.04', 'bionic'], 'arches': ['arm64v8', 'arm32v7', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['latest', '20.04', 'focal'], 'arches': ['arm64v8', 'arm32v7', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}]
    other_options = {
        "pre_build_commands": {
            "image": "docker:git",
            "commands": [
